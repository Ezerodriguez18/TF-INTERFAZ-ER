...
"  border: none;")
    ...
    def calculo(self):
        ...
        f, pxx = utils.periodogram(signal_no_dc, 60*1e6//(self.numdiezmado), window=('kaiser', 38), method="welch", scaling="spectrum")
        originpxx=pxx
        ...
        leftBinFund, rightBinFund = utils._get_peak_border(pxx, f, fund_freq, fund_idx, 0)
